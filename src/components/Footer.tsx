...
//               className="px-4 py-2 w-80 rounded-md border-none focus:ring-2 focus:ring-gray-300"
//             />
//             <button
//               type="submit"
...
//                   <Image src={"./footer/twitter.svg"} alt="" width={24} height={24} />
//                 </Link>

//                 <Link href="#" className="text-gray-700 hover:text-black">
//                 <Image src={"./footer/facebook.svg"} alt="" width={24} height={24} />
//                 </Link>

//                 <Link href="#" className="text-gray-700 hover:text-black">
//                 <Image src={"./footer/instagram.svg"} alt="" width={24} height={24} />
//                 </Link>

//                 <Link href="#" className="text-gray-700 hover:text-black">
//                 <Image src={"./footer/github.svg"} alt="" width={24} height={24} />
//                 </Link>
...
//               <img src="/footer/badge.svg" alt="badge" className="h-6" />
//               <img src="/footer/paypal.svg" alt="PayPal" className="h-6" />
//               <img src="/footer/apple.svg" alt="Apple Pay" className="h-6" />
//               <img src="/footer/google.svg" alt="Google Pay" className="h-6" />
//             </div>
//           </div>
//         </div>
//       </footer>
      ...
      <footer className="bg-gray-100">
        ...
        <div className="bg-gray-200 py-4">
          <div className="container mx-auto flex flex-wrap justify-between items-center text-sm text-gray-600 px-4 md:px-6 lg:px-10">
            <p className="w-full md:w-auto text-center md:text-left mb-4 md:mb-0">Shop.co © 2000-2023, All Rights Reserved</p>
